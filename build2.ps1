...
$tagSpecEC2KeyPair = New-Object Amazon.EC2.Model.TagSpecification; $tagSpecEC2KeyPair.ResourceType = "vpc"; $tagSpecEC2KeyPair.Tags.Add($tagEC2KeyPair1); $tagSpecEC2KeyPair.Tags.Add($tagEC2KeyPair2)
$myBuild2KeyPair = New-EC2KeyPair -KeyName myBuild2KeyPair -TagSpecification $tagSpecEC2KeyPair
